        ...
        <div class="p-2 m-5">
            ...
            <div class="container w-75 ms-5 border border-black border-1 mt-3 px-5 rounded shadow-lg">
                <form action="" enctype="file">
                    <div class="row my-4">
                        <button type="submit" class="btn btn-success col-sm-4 offset-sm-8 shadow">
                            Ajukan Sertifikat
                    ...
                    <div class="row mb-5">
                        <label for="foto" class="col-3 offset-sm-2"">Foto*</label>
                        <input type="file" name="foto" id="foto" class="col-5">
                    </div>
                </form>
            </div>
            <div class="row my-5">
                <button type="submit" class="btn btn-success col-sm-3 offset-sm-4 shadow">
