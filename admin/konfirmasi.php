...
<body>
    <div class="container-fluid">
        <div class="p-2 m-5">
                ...
                <div class="offcanvas-body p-0">
                    <div class="container">
                        <div class="list_menu row">
                            <a href="peserta.php" class="py-3 col-sm-10 offset-sm-2">
                        ...
                        <div class="list_menu row">
                            <a href="konfirmasi.php" class="py-3 col-sm-10 offset-sm-2">
            ...
            <div class="row">
                <form action="" method="post" class="col-sm-4 offset-sm-8">
